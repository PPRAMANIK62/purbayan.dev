...
export default function HomePage() {
  usePageMeta({
    description: "Purbayan Pramanik — full-stack developer. TypeScript by day, Rust by night.",
  })
      ...
      <section className="max-w-3xl mx-auto px-6 py-24">
        <FadeUp>
          <p className="text-lg text-secondary-foreground leading-relaxed">
            I write TypeScript at work, hack on Rust and C in my free time, and configure my
            Hyprland setup more than I probably should.
          </p>
          <Link to="/about" className="text-primary font-mono hover:underline mt-4 inline-block">
            → more about me
          </Link>
        </FadeUp>
      </section>
